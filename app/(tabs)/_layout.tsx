...
function TabLayoutContent() {
  ...
  console.log('TabLayout: accessGranted:', accessGranted, 'showAccessDenied:', showAccessDenied, 'currentUrl:', currentUrl, 'isOnHilochHomepage:', isOnHilochHomepage, 'isOnLoginPage:', isOnLoginPage, 'isWebViewLoaded:', isWebViewLoaded, '- Navbar will be', shouldShowNavbar ? 'VISIBLE' : 'HIDDEN');
