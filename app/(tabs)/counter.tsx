            ...
            <View style={styles.stagesContainer}>
              ...
              {isStage1Completed && !stage1Expanded ? (
                ...
                <View style={[
                  ...
                  {/* Icon first in JSX, stageHeader uses row-reverse → icon goes to the RIGHT */}
                  ...
                  <View style={styles.progressContainer}>
                    ...
                    <Text style={styles.progressText}>{Math.round(stage1Progress)}%</Text>
                  </View>
              ...
              {isStage2Completed && !stage2Expanded ? (
                ...
                <View style={[
                  ...
                  <View style={styles.progressContainer}>
                    ...
                    <Text style={styles.progressText}>{Math.round(stage2Progress)}%</Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  dateCard: {
    ...
    ...Platform.select({
      ios: { shadowColor: '#4FC3F7', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12 },
      android: { elevation: 4 },
      web: { boxShadow: '0px 4px 16px rgba(79, 195, 247, 0.12)' },
    }),
  },
  dateCardCollapsed: {
    backgroundColor: colors.card,
    ...
    borderColor: colors.border,
    ...Platform.select({
      ios: { shadowColor: '#4FC3F7', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 6 },
      android: { elevation: 2 },
      web: { boxShadow: '0px 2px 10px rgba(79, 195, 247, 0.1)' },
    }),
  },
  dateCardHeader: {
  ...
  stageCardActive: {
    ...
    borderWidth: 2,
    ...Platform.select({
      ios: { shadowColor: '#4FC3F7', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 12 },
      android: { elevation: 6 },
      web: { boxShadow: '0px 4px 20px rgba(79, 195, 247, 0.25)' },
    }),
  },
  stageCardCompleted: {
    borderColor: '#4CAF50',
    borderWidth: 2,
    ...Platform.select({
      ios: { shadowColor: '#4CAF50', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 10 },
      android: { elevation: 5 },
      web: { boxShadow: '0px 4px 16px rgba(76, 175, 80, 0.2)' },
    }),
  },
  stageCardCollapsed: {
    backgroundColor: colors.card,
    ...
    borderColor: '#4CAF50',
    ...Platform.select({
      ios: { shadowColor: '#4CAF50', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 6 },
      android: { elevation: 3 },
      web: { boxShadow: '0px 2px 10px rgba(76, 175, 80, 0.15)' },
    }),
  },
  collapsedContent: {
    flexDirection: 'row-reverse',
  ...
  // row-reverse + icon FIRST in JSX = icon on the RIGHT, text on the LEFT
  stageHeader: {
    flexDirection: 'row-reverse',
    alignItems: 'center',
    gap: 14,
  ...
  // forceRTL mirrors alignItems: flex-start becomes visually RIGHT-aligned
  stageTitleContainer: {
    flex: 1,
    alignItems: 'flex-start',
  },
  // forceRTL mirrors textAlign: 'left' renders visually on the RIGHT
  stageTitle: {
    fontSize: 20,
    fontWeight: '700',
    color: colors.text,
  ...
  // forceRTL mirrors left/right: 'left: 0' fills from the visual RIGHT side
  progressFill: {
    height: '100%',
    borderRadius: 5,
    position: 'absolute',
